...
- шаблон грид-колонок (`grid-template-volumns`) - нужно сделать три колонки одинаковой ширины, занимающие вместе всю ширину контейнера (используйте функцию `repeat()`).
